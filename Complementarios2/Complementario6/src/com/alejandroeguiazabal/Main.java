...
donde la clave (key) es el dni y el valor (value) es el sueldo calculado. */
    ...
    public static void main(String[] args) {
        ...
        HashSet<String> empleado = new HashSet<String>();

        empleado.add("Paloma");
        empleado.add("Almendra");
        empleado.add("Camilo");
        empleado.add("Alejandro");
        empleado.add("Cecilia");

        HashMap<String, Integer, Integer, Integer, Integer> calculoSueldo = new HashMap<>(0);
        Map
